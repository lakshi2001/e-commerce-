...
$cust_password = $_POST['cust_password'];
    ...
    if($valid == 1) {
        ...
        $q = "INSERT INTO tbl_customer (`cust_name`,`cust_email`,`cust_phone`,`cust_country`,`cust_address`,`cust_city`,`cust_state`,`cust_zip`,`cust_password`,`cust_token`,`cust_datetime`,`cust_timestamp`,`cust_status`) VALUES ('".$cust_name."','".$cust_email."','".$cust_phone."','".$cust_country."','".$cust_address."','".$cust_city."','".$cust_state."','".$cust_zip."','".$cust_password."','".$token."','".$cust_datetime."','".$cust_timestamp."','1')";
        $statement = $coon->query($q);

        $success_message = "Registration Successfully Plaese Login your Account";
