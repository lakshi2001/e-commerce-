...
if (isset($_POST['form_add_to_fa'])) {
    ...
    if (isset($_SESSION['fa_p_id'])) {
        ...
        if ($added == 1) {
            ...
            $i = 0;
            foreach ($_SESSION['fa_p_id'] as $key => $res) {
                $i++;
            }
            $new_key = $i + 1;
            ...
            $_SESSION['fa_p_id'][$new_key] = $_REQUEST['id'];
            $_SESSION['fa_size_id'][$new_key] = $size_id;
            $_SESSION['fa_size_name'][$new_key] = $size_name;
            $_SESSION['fa_color_id'][$new_key] = $color_id;
            $_SESSION['fa_color_name'][$new_key] = $color_name;
            $_SESSION['fa_p_qty'][$new_key] = $_POST['p_qty'];
            $_SESSION['fa_p_current_price'][$new_key] = $_POST['p_current_price'];
            $_SESSION['fa_p_name'][$new_key] = $_POST['p_name'];
            $_SESSION['fa_p_featured_photo'][$new_key] = $_POST['p_featured_photo'];
        ...
        $_SESSION['fa_p_id'][1] = $_REQUEST['id'];
        $_SESSION['fa_size_id'][1] = $size_id;
        $_SESSION['fa_size_name'][1] = $size_name;
        $_SESSION['fa_color_id'][1] = $color_id;
        $_SESSION['fa_color_name'][1] = $color_name;
        $_SESSION['fa_p_qty'][1] = $_POST['p_qty'];
        $_SESSION['fa_p_current_price'][1] = $_POST['p_current_price'];
        $_SESSION['fa_p_name'][1] = $_POST['p_name'];
        $_SESSION['fa_p_featured_photo'][1] = $_POST['p_featured_photo'];
    ...
    // $success_message1 = 'Product is added to the Favourite successfully!';
            ...
            <div class="col-md-12">
                <div class="breadcrumb mb_30">
                    <ul>
                        ...
                        <li>></li>
                        <li><a
                                href="<?php echo BASE_URL . 'product-category.php?id=' . $tcat_id . '&type=top-category' ?>"><?php echo $tcat_name; ?></a></li>
                        <li>></li>
                        <li><a
                                href="<?php echo BASE_URL . 'product-category.php?id=' . $mcat_id . '&type=mid-category' ?>"><?php echo $mcat_name; ?></a></li>
                        <li>></li>
                        <li><a
                                href="<?php echo BASE_URL . 'product-category.php?id=' . $ecat_id . '&type=end-category' ?>"><?php echo $ecat_name; ?></a></li>
                        <li>></li>
                        <li>
                            <?php echo $p_name; ?>
                        </li>
                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="btn-cart btn-cart1">
                                    ...
                                    <input type="submit" value="Buy Now" name="form_buy_now" style="background-color: green; margin-left: 10px;">
                                </div>
                                <div class="btn-cart btn-cart1">
                                    <input type="submit" value="Add To Favourite" name="form_add_to_fa"
                    ...
                    <div class="row mtopp">
                        ...
                        <div class="col-12 col-md-6 ml">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <a href="vendorhome.php?id=<?php echo $row['id']; ?>"><button class="btn btn-primary row3">Follow</button></a>
                                </div>
                            </div>
