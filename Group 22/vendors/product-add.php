						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
									...
									<?php
									$statement2 = $pdo->prepare("SELECT * FROM tbl_mid_category ORDER BY mcat_name ASC");
									$statement2->execute();
									$result2 = $statement2->fetchAll(PDO::FETCH_ASSOC);	
									foreach ($result2 as $row2) {
										?>
										<option value="<?php echo $row2['mcat_id']; ?>"><?php echo $row2['mcat_name']; ?></option>
										<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
									...
									<?php
									$statement3 = $pdo->prepare("SELECT * FROM tbl_end_category ORDER BY ecat_name ASC");
									$statement3->execute();
									$result3 = $statement3->fetchAll(PDO::FETCH_ASSOC);	
									foreach ($result3 as $row3) {
										?>
										<option value="<?php echo $row3['ecat_id']; ?>"><?php echo $row3['ecat_name']; ?></option>
										<?php
									}
									?>
								</select>
